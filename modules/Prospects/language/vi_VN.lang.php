...
$mod_strings = array(
    ...
    'LBL_NAME' => 'Tên:',
    'LBL_PROSPECT_INFORMATION' => 'Xem toàn bộ Đối tượng', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template

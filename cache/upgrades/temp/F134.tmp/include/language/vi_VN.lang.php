...
$app_strings = array(
    ...
    'DEFAULT' => 'Cơ bản', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_SORT' => 'Sắp xếp',
    ...
    'LBL_EMAIL_MESSAGE_NO' => 'Tin nhắn số.', // Counter. Message number xx . Issue 8917
    ...
    'LBL_LINK_ACTIONS' => 'Hành động', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_CREATE_BUTTON_LABEL' => 'Tạo', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_CAMPAIGNLOG' => 'Log Chiến dịch', // issue 8919
    ...
    'LBL_OR' => 'Hoặc',
    'LBL_PANEL_OVERVIEW' => 'Xem toàn bộ', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PANEL_ASSIGNMENT' => 'Khác', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_PANEL_ADVANCED' => 'Thông tin thêm', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Hàng loạt hành động', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Hành động', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
...
$app_strings['LBL_SUITE_DASHBOARD'] = 'Bảng điều khiển SuiteCRM'; //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template actions
...
$app_strings['LBL_SUITE_DASHBOARD_ACTIONS'] = 'Hành động'; //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
...
$app_strings['LBL_SEARCH_OF'] = ' của '; // Usage: Page # of #

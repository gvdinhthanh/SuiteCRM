...
<?php echo '\' );
addToValidate(\'form_QuickCreate_Contacts\', \'date_entered_date\', \'date\', false,\'Ngày tạo\' );
addToValidate(\'form_QuickCreate_Contacts\', \'date_modified_date\', \'date\', false,\'Ngày điều chỉnh\' );
